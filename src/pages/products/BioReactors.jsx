      ...
      <div className="flex justify-center px-4 py-24 bg-gradient-to-b from-gray-900 via-gray-800 to-black text-white">
        ...
        >
          ...
          <div className="w-full md:w-3/4 md:-ml-20 md:-mt-[-100px] bg-white/10 backdrop-blur-lg text-white rounded-2xl shadow-2xl p-10 border border-white/20 z-10">
            <h2 className="text-4xl  mb-6 drop-shadow-md">Bioreactors</h2>

            <p className="pb-4 text-white">
              Bioreactor design allows for the growth of cells, microorganisms,
              or enzymes, which in turn produce valuable products such as
              pharmaceuticals, bifuels, and food ingredients.
            </p>
            <ul className="list-disc list-outside list-inside  space-y-2 text-white">
              <li>Minimum Space requirement</li>
              <li>Optimized Bioreactor Design</li>
